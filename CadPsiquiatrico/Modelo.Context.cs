...
namespace CadPsiquiatrico
{
    ...
    public partial class LabPsiquiatricoEntities1 : DbContext
    {
        ...
        public virtual ObjectResult<paPersonalListar_Result> paPersonalListar(string parametro)
        {
            var parametroParameter = parametro != null ?
                new ObjectParameter("parametro", parametro) :
                new ObjectParameter("parametro", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<paPersonalListar_Result>("paPersonalListar", parametroParameter);
        }
